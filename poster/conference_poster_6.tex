...
\VeryHuge \color{HoGentAccent1} \textbf{Correlatie tussen gebruik van elektronische devices en slaagcijfers van studenten in hogescholen} \color{Black}\\ % Title
\Huge\textit{Studentenenquête en test of een les zonder smartphone of laptop een verbetering oplevert voor de student}\\[2.4cm] % Subtitle
